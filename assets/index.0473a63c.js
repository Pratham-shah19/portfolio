...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jt,depthTest:!1,depthWrite:!1})}function Mo(){return new gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:Jt,depthTest:!1,depthWrite:!1})}function So(){return new gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fs(),fragmentShader:`
...
`].filter(si).join(`
`)),o=ns(o),o=Do(o,t),o=Ro(o,t),a=ns(a),a=Do(a,t),a=Ro(a,t),o=Io(o),a=Io(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(M=`#version 300 es
